...
- ระบบส่งงานพร้อมสถานะ `ส่งแล้ว/ยังไม่ส่ง`
- Export ข้อมูลนักเรียน คะแนน ความคืบหน้า และสถานะส่งงานเป็นไฟล์ Excel
- มีไฟล์ `student_records_template.xlsx` สำหรับครูใช้รวบรวมข้อมูล
...
## การบันทึกข้อมูลและ Excel

ในหน้าเว็บ นักเรียนต้องทำตามลำดับ:

1. กรอกข้อมูลนักเรียน
2. ทำ Workshop ให้ครบ 13 ขั้น โดยต้องตอบ checkpoint ของแต่ละขั้นให้ถูก
3. ทำโจทย์ฝึกอย่างน้อย 6 จาก 8 ข้อ
4. ทำแบบวัดผล 10 ข้อ
5. กดส่งงานเพื่อบันทึกสถานะ
6. กด Export Excel เพื่อดาวน์โหลดไฟล์ผลการเรียนรู้ของตนเอง

ไฟล์ Excel ที่ export จะมีชีต:
